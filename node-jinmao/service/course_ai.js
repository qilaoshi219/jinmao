...
const MAX_CHAPTER_CHARS = 600000;       // 注入上下文的章节原文最大字符数
...
function buildSystemContent(course, chapter, chapterText) {
  const sections = [
    "你是「金毛教你学」课程学习页的 AI 助教，负责帮助学员理解当前课程的内容。",
    "回答要求：",
    "1. 严格基于下方提供的【本章内容】和【当前页素材】作答，不要编造教材中没有的知识；",
    "2. 如用户的问题超出教材范围，请明确指出并建议其以教材为准；",
    "3. 使用通俗易懂的中文，可结合例子讲解，回答保持简洁；",
    "4. 对于计算题或定义类问题，给出清晰步骤与结论。",
    "",
