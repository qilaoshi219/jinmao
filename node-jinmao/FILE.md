...
| 文件名 | 用途 | 最后修改 |
|--------|------|----------|
| `app.js` | Express HTTP 服务器，监听 8888 端口，挂载 /api/v1 路由，集成 helmet/cors/JSON 解析中间件 | 2026-07-04 |
| `package.json` | 定义项目名、依赖（express、nodemailer、Prisma 等）、启动脚本 | 2026-07-04 |
...
| `prisma/schema.prisma` | Prisma ORM 数据库 Schema 定义，包含 User 模型，映射 MySQL 表 | 2026-07-04 |
